...
const MOCK_SESSIONS: ScanSession[] = [
    { key: '1', scannedAt: '2026-08-10T14:20:00', leftScanId: 101, rightScanId: 102, skinToneHex: representativePersonalColor('spring_light'), seasonCode: 'spring_light', seasonNameKo: '봄 라이트', shape: 'oval', recommendedShape: 'round', status: 'COMPLETED', avgLengthMm: 12.4, avgWidthMm: 9.6, avgCurve: 0.58 },
    { key: '2', scannedAt: '2026-08-05T10:05:00', leftScanId: 103, rightScanId: 104, skinToneHex: representativePersonalColor('summer_bright'), seasonCode: 'summer_bright', seasonNameKo: '여름 브라이트', shape: 'oval', recommendedShape: 'oval', status: 'COMPLETED', avgLengthMm: 13.1, avgWidthMm: 9.0, avgCurve: 0.51 },
    { key: '3', scannedAt: '2026-07-28T18:42:00', leftScanId: 105, rightScanId: 106, skinToneHex: representativePersonalColor('autumn_deep'), seasonCode: 'autumn_deep', seasonNameKo: '가을 딥', shape: 'almond', recommendedShape: 'almond', status: 'COMPLETED', avgLengthMm: 12.9, avgWidthMm: 8.7, avgCurve: 0.63 },
    { key: '4', scannedAt: '2026-07-20T09:15:00', leftScanId: 107, rightScanId: 108, skinToneHex: representativePersonalColor('winter_vivid'), seasonCode: 'winter_vivid', seasonNameKo: '겨울 비비드', shape: 'stiletto', recommendedShape: 'stiletto', status: 'COMPLETED', avgLengthMm: 14.2, avgWidthMm: 8.2, avgCurve: 0.47 },
    { key: '5', scannedAt: '2026-07-12T16:30:00', leftScanId: 109, rightScanId: 110, skinToneHex: representativePersonalColor('spring_bright'), seasonCode: 'spring_bright', seasonNameKo: '봄 브라이트', shape: 'ballerina', recommendedShape: 'ballerina', status: 'COMPLETED', avgLengthMm: 11.8, avgWidthMm: 10.1, avgCurve: 0.55 },
    { key: '6', scannedAt: '2026-07-01T11:00:00', leftScanId: 111, rightScanId: 112, skinToneHex: representativePersonalColor('summer_soft'), seasonCode: 'summer_soft', seasonNameKo: '여름 소프트', shape: 'square', recommendedShape: 'square', status: 'COMPLETED', avgLengthMm: 12.0, avgWidthMm: 9.9, avgCurve: 0.44 },
    { key: '7', scannedAt: '2026-06-20T13:50:00', leftScanId: 113, rightScanId: 114, skinToneHex: representativePersonalColor('autumn_mute'), seasonCode: 'autumn_mute', seasonNameKo: '가을 뮤트', shape: 'round', recommendedShape: 'round', status: 'COMPLETED', avgLengthMm: 13.5, avgWidthMm: 9.3, avgCurve: 0.60 },
]
