...
const MOCK_SESSIONS: ScanSession[] = [
    { key: '1', scannedAt: '2026-08-10T14:20:00', leftScanId: 101, rightScanId: 102, skinToneHex: '#F3D2B8', tone: 'warm', warmness: 14.2, brightness: 0.78, saturation: 0.32, recommendedColors: [], shape: 'oval', recommendedShape: 'round', status: 'COMPLETED', avgLengthMm: 12.4, avgWidthMm: 9.6, avgCurve: 2.3 },
    { key: '2', scannedAt: '2026-08-05T10:05:00', leftScanId: 103, rightScanId: 104, skinToneHex: '#EFC7B0', tone: 'cool', warmness: 11.6, brightness: 0.7, saturation: 0.4, recommendedColors: [], shape: 'oval', recommendedShape: 'oval', status: 'COMPLETED', avgLengthMm: 13.1, avgWidthMm: 9.0, avgCurve: 2.0 },
    { key: '3', scannedAt: '2026-07-28T18:42:00', leftScanId: 105, rightScanId: 106, skinToneHex: '#C89A78', tone: 'warm', warmness: 13.9, brightness: 0.55, saturation: 0.45, recommendedColors: [], shape: 'almond', recommendedShape: 'almond', status: 'COMPLETED', avgLengthMm: 12.9, avgWidthMm: 8.7, avgCurve: 2.7 },
    { key: '4', scannedAt: '2026-07-20T09:15:00', leftScanId: 107, rightScanId: 108, skinToneHex: '#D9AFA0', tone: 'cool', warmness: 11.9, brightness: 0.6, saturation: 0.5, recommendedColors: [], shape: 'stiletto', recommendedShape: 'stiletto', status: 'COMPLETED', avgLengthMm: 14.2, avgWidthMm: 8.2, avgCurve: 1.8 },
    { key: '5', scannedAt: '2026-07-12T16:30:00', leftScanId: 109, rightScanId: 110, skinToneHex: '#F0D0BE', tone: 'warm', warmness: 15.1, brightness: 0.8, saturation: 0.35, recommendedColors: [], shape: 'ballerina', recommendedShape: 'ballerina', status: 'COMPLETED', avgLengthMm: 11.8, avgWidthMm: 10.1, avgCurve: 2.2 },
    { key: '6', scannedAt: '2026-07-01T11:00:00', leftScanId: 111, rightScanId: 112, skinToneHex: '#E4C9BC', tone: 'cool', warmness: 12.0, brightness: 0.68, saturation: 0.3, recommendedColors: [], shape: 'square', recommendedShape: 'square', status: 'COMPLETED', avgLengthMm: 12.0, avgWidthMm: 9.9, avgCurve: 1.6 },
    { key: '7', scannedAt: '2026-06-20T13:50:00', leftScanId: 113, rightScanId: 114, skinToneHex: '#D3A587', tone: 'warm', warmness: 13.7, brightness: 0.58, saturation: 0.42, recommendedColors: [], shape: 'round', recommendedShape: 'round', status: 'COMPLETED', avgLengthMm: 13.5, avgWidthMm: 9.3, avgCurve: 2.5 },
]
